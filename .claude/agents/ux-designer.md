...
8. Color semantics: planned, active, completed, warning, and error states must feel distinct in both hue and lightness
...
- Premium quality in this repo means calm hierarchy, consistent spacing, clear states, restrained color use.
...
- Prefer the richer house palette over fallback blue/green defaults when a semantic mapping already exists in `app/globals.css`.
