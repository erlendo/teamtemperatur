  ...
  return (
    <div style={{ maxWidth: 720 }}>
      ...
      <form method="get" style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 14 }}>
        <label>Uke</label>
        <input name="week" defaultValue={week} type="number" min={1} max={53} style={{ width: 120, padding: 10 }} />
      ...
      {stats.length === 0 ? (
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr>
              <th style={{ textAlign: "left", borderBottom: "1px solid #ddd", padding: 8 }}>Spørsmål</th>
              <th style={{ textAlign: "left", borderBottom: "1px solid #ddd", padding: 8 }}>Snitt</th>
              <th style={{ textAlign: "left", borderBottom: "1px solid #ddd", padding: 8 }}>Antall</th>
            </tr>
          </thead>
          <tbody>
            {stats.map((r) => (
