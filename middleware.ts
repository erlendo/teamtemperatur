...
export async function middleware(req: NextRequest) {
  ...
  if (code) {
    ...
    if (error) {
      console.error("[Middleware] exchangeCodeForSession error:", error.message, error.status);
      ...
      console.log("[Middleware] OTP exchange successful for:", req.nextUrl.pathname);
    }
  }
