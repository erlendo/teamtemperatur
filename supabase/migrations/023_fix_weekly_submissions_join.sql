-- Fix get_team_year_stats to correctly count respondents
-- Problem: weekly_submissions was using INNER JOIN with answers/questions,
-- which could miss submissions if they had NULL answers or other edge cases.
-- Solution: Count distinct submitted_by directly from submissions table.
